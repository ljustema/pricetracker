...
import PythonScraperForm from "@/components/scrapers/python-scraper-form";
import TestResultsModal from "@/components/scrapers/test-results-modal";
import { useSession } from "next-auth/react";

type Step = 'select-type' | 'create-ai' | 'create-python';
    ...
    switch (step) {
      ...
      case 'create-python':
        return (
          <PythonScraperForm
            competitorId={competitorId}
            onSuccess={handlePythonScraperCreated}
            onCancel={handleCancel}
          />
        );
      default:
