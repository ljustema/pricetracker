...
// Metadata can be defined here now
...
// Landing page component logic moved directly here
            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  ...
                  {/* Link to pricing under marketing-routes */}
...
export default async function Home() {
  ...
  // Otherwise, render the marketing landing page content
