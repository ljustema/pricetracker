...
interface BrandStatisticsClientProps {
  brands: Brand[];
  topCompetitors?: CompetitorStat[];
  totalBrands: number;
  totalProducts: number;
  topBrands: Brand[];
  brandsOver1000: number;
  brands500to999: number;
  brands100to499: number;
  brands10to99: number;
  brands1to9: number;
}

const BrandStatisticsClient: React.FC<BrandStatisticsClientProps> = ({ 
  totalBrands,
  totalProducts,
  topBrands,
  topCompetitors = [],
...
export default BrandStatisticsClient;
