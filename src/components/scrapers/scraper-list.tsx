...
export default function ScraperList({
  ...
  const handleActivate = useCallback(async (scraperId: string) => {
    setActivatingId(scraperId);
    ...
    try {
      ...
      alert(error instanceof Error ? error.message : "Failed to activate scraper");
    } finally {
                  ...
                  {scraper.is_approved && (
                    <>
                      {!scraper.is_active && (
                        <button
                          type="button"
                          onClick={() => handleActivate(scraper.id!)}
                        ...
                        >
                          {activatingId === scraper.id ? "Activating..." : "Activate"}
                        </button>
                      )}
