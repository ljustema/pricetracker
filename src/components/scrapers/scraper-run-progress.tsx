  ...
  return (
    <div className="space-y-4">
      ...
      {progress.errorMessage && (
        <div className={`p-3 rounded-md ${progress.errorMessage.startsWith('INFO:') ? 'bg-blue-50' : 'bg-red-50'}`}>
          <div className="flex">
            <div className="flex-shrink-0">
              {progress.errorMessage.startsWith('INFO:') ? (
            ...
            <div className="ml-3 w-full">
              <h3 className={`text-sm font-medium ${progress.errorMessage.startsWith('INFO:') ? 'text-blue-800' : 'text-red-800'}`}>
                {progress.errorMessage.startsWith('INFO:') ? 'Information' : 'Error'}
              </h3>
              <div className={`mt-1 text-sm ${progress.errorMessage.startsWith('INFO:') ? 'text-blue-700' : 'text-red-700'}`}>
                <p>{progress.errorMessage.startsWith('INFO:') ? progress.errorMessage.substring(5).trim() : progress.errorMessage}</p>
              </div>
