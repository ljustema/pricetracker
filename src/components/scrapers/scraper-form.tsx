...
export default function ScraperForm({
  ...
  // Determine the scraper type from initialData or default to "typescript"
  const defaultScraperType = initialData?.scraper_type || "typescript";
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <select
            id="scraper_type"
            name="scraper_type"
            value={formData.scraper_type || "typescript"}
            onChange={handleChange}
            className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
          >
            <option value="typescript">TypeScript Scraper</option>
        ...
        <div>
          ...
          <div className="mt-1 flex rounded-md shadow-sm">
            ...
            />
            {onGenerateWithAI && formData.scraper_type === "typescript" && (
              <button
                type="button"
        ...
        {/* TypeScript Scraper Fields */}
        {formData.scraper_type === "typescript" && (
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <label htmlFor="selectors.competitor_price" className="block text-sm font-medium">
                Price Selector
              </label>
              <input
                id="selectors.competitor_price"
                name="selectors.competitor_price"
                type="text"
                value={formData.selectors?.competitor_price || ""}
                onChange={handleChange}
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
